...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default='train_test', help='Path to training dataset')
    parser.add_argument('--preprocess_dir', type=str, default='prep_test', help='Path to save/load preprocessed data')
